...
void init_hash(void) {
  ...
  char *keyword[] = {"int",  "char",  "struct", "NULL",  "return",   "if",
                     "else", "while", "for",    "break", "continue", NULL};
  int tokentype[] = {TYPE, TYPE,  STRUCT, SYM_NULL, RETURN,   IF,
                     ELSE, WHILE, FOR,    BREAK,    CONTINUE, 0};
